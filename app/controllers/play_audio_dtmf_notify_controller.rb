class PlayAudioDtmfNotifyController < ActionController::API
  def create
    ...
    when 'CallStart'
      render json: { response_type: 'PlayAudio', dtmf: true, notify_no_input: true, num_digits: 1, audio_list: ['https://toolkit-simulator.herokuapp.com/audio/playaudiodtmf.mp3'], audio_loop: 3 }
    when 'KeyPress'
