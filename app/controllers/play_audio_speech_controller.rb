class PlayAudioSpeechController < ActionController::API
  def create
    ...
    when 'CallStart'
      render json: { response_type: 'PlayAudio', barge_in: false, speech_hints: 'zoove, starstar, mobile', speech: true, timeout: 1, finish_on_key: '#', audio_list: ['https://toolkit-simulator.herokuapp.com/audio/playaudiospeech.mp3'] }
    when 'Speech'
